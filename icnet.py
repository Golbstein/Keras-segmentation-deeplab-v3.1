...
def build(width, height, n_classes, weights_path=None, train=False):
    ...
    out = Reshape((n_classes, width*height//16))(out)
    if train:
...
def build_bn(image_size, n_classes, weights_path=None, train=False):
    image_size += (3,)
    ...
    if train:
        ...
        aux_1 = Reshape((-1, n_classes))(aux_1)
        aux_2 = Reshape((-1, n_classes))(aux_2)
